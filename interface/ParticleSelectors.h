...
class ParticleSelector {
  public:
    ...
    void FindGenParticles(const TClonesArray& genParticles, const TClonesArray& _recoPhotons, vector<TCGenParticle>& _genPhotons, vector<TCGenParticle>& _genMuons,
        vector<TCGenParticle>& _genElectrons, vector<TCGenParticle>& _genZs, genHZGParticles& _genHZG,bool& vetoDY);
