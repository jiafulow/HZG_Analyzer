...
C---set to zero if x out of range
      ...
      if      (pdlabel(1:5) .eq. 'mstw8') then
            ...
            prefix = checkpath('../hzgammaME/Pdfdata/mstw2008lo') ! LO grid
            elseif     (pdlabel .eq. 'mstw8nl') then
            prefix = checkpath('../hzgammaME/Pdfdata/mstw2008nlo') ! NLO grid
            elseif     (pdlabel .eq. 'mstw8nn') then
            prefix = checkpath('../hzgammaME/Pdfdata/mstw2008nnlo') ! NNLO grid
            endif
