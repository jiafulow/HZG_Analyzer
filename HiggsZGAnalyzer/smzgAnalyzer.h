...
#ifndef smzgAnalyzer_h
#define smzgAnalyzer_h
...
class smzgAnalyzer : public TSelector {
  public :
...
#ifdef smzgAnalyzer_cxx
void smzgAnalyzer::Init(TTree *tree)
{
