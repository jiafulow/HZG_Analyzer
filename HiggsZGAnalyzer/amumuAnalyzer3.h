...
#ifndef amumuAnalyzer3_h
#define amumuAnalyzer3_h
...
class amumuAnalyzer3 : public TSelector {
  public :
    ...
    auto_ptr<HistManager> hm;
  	...
  	ClassDef(amumuAnalyzer3,0);
};

#endif

#ifdef amumuAnalyzer3_cxx
void amumuAnalyzer3::Init(TTree *tree)
{
...
#endif // #ifdef amumuAnalyzer3_cxx
