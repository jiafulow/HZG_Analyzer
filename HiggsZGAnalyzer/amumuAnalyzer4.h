...
#ifndef amumuAnalyzer4_h
#define amumuAnalyzer4_h
...
class amumuAnalyzer4 : public TSelector {
  public :
    ...
    float jetThreeEta;
    float jetThreePhi;
    float jetThreeEnergy;
    float jetThreeCSV;
    float jetThreeCSVv1;
    float jetThreeCSVMVA;
    float jetThreePUID;
    float metPt;
    float metPhi;
    ...
    //TLorentzVector jetOneGen;
    //TLorentzVector fjetGen;

    // Default functions

    amumuAnalyzer4(TTree * /*tree*/ =0) :
      fChain(0),
      fileCount(0),
    ...
    ClassDef(amumuAnalyzer4,0);
};

#endif

#ifdef amumuAnalyzer4_cxx
void amumuAnalyzer4::Init(TTree *tree)
{
...
#endif // #ifdef amumuAnalyzer4_cxx
