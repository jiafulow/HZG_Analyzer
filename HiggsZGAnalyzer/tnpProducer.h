...
#ifndef tnpProducer_h
#define tnpProducer_h
...
class tnpProducer : public TSelector {
  public :
    ...
    auto_ptr<TFile> tnpFile;
    auto_ptr<TTree> tnpTree;
...
#ifdef tnpProducer_cxx
void tnpProducer::Init(TTree *tree)
{
