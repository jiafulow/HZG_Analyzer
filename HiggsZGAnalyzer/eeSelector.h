...
class eeSelector : public TSelector {
  public :
    ...
    auto_ptr<TFile> eleFile;
    auto_ptr<TTree> eleTree;
    ...
    ClassDef(eeSelector,0);
};

#endif

#ifdef eeSelector_cxx
void eeSelector::Init(TTree *tree)
{
