...
t3storage2  = '/tthome/jiafulow/HZG/CMSSW_6_1_1/src/HZG_Analyzer/HiggsZGAnalyzer/skims/'
...
#################
  ...
  if not doSkim:
    configs.append(b.JobConfig('DYJetsToLL_M-10To50', t3storage+'/nuTuples_v9.10_8TeV/MC/DYJetsToLL_M-10To50', 50, 'DYJetsToLL_M-10To50 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('DYJetsToLL_M-50', t3storage+'/nuTuples_v9.10_8TeV/MC/DYJetsToLL_M-50', 50, 'DYJetsToLL_M-50 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_FullLep', t3storage+'/nuTuples_v9.10_8TeV/MC/TTJets_FullLep', 50, 'TTJets_FullLep ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_Hadronic', t3storage+'/nuTuples_v9.10_8TeV/MC/TTJets_Hadronic', 50, 'TTJets_Hadronic ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_SemiLep', t3storage+'/nuTuples_v9.10_8TeV/MC/TTJets_SemiLep', 50, 'TTJets_SemiLep ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TT_FCNH_M-30', t3storage+'/nuTuples_v9.10_8TeV/MC/TT_FCNH_M-30', 5, 'TT_FCNH_M-30 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
  else:
    configs.append(b.JobConfig('DYJetsToLL_M-50', t3storage2+'/nuTuples_v9.10_8TeV/MC/DYJetsToLL_M-50', 4, 'DYJetsToLL_M-50 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('DYJetsToLL_M-10To50', t3storage2+'/nuTuples_v9.10_8TeV/MC/DYJetsToLL_M-10To50', 2, 'DYJetsToLL_M-10To50 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_FullLep', t3storage2+'/nuTuples_v9.10_8TeV/MC/TTJets_FullLep', 2, 'TTJets_FullLep ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_Hadronic', t3storage2+'/nuTuples_v9.10_8TeV/MC/TTJets_Hadronic', 2, 'TTJets_Hadronic ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('TTJets_SemiLep', t3storage2+'/nuTuples_v9.10_8TeV/MC/TTJets_SemiLep', 2, 'TTJets_SemiLep ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('DY1JetsToLL_M-50', t3storage2+'/nuTuples_v9.10_8TeV/MC/DY1JetsToLL_M-50', 4, 'DY1JetsToLL_M-50 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    ...
    configs.append(b.JobConfig('WZ', t3storage2+'/nuTuples_v9.10_8TeV/MC/WZ', 2, 'WZ ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('ZZ', t3storage2+'/nuTuples_v9.10_8TeV/MC/ZZ', 4, 'ZZ ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('WWJetsTo2L2Nu', t3storage2+'/nuTuples_v9.10_8TeV/MC/WWJetsTo2L2Nu', 2, 'WWJetsTo2L2Nu ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('WZJetsTo2L2Q', t3storage2+'/nuTuples_v9.10_8TeV/MC/WZJetsTo2L2Q', 1, 'WZJetsTo2L2Q ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('WZJetsTo3LNu', t3storage2+'/nuTuples_v9.10_8TeV/MC/WZJetsTo3LNu', 1, 'WZJetsTo3LNu ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('ZZJetsTo2L2Nu', t3storage2+'/nuTuples_v9.10_8TeV/MC/ZZJetsTo2L2Nu', 1, 'ZZJetsTo2L2Nu ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('ZZJetsTo2L2Q', t3storage2+'/nuTuples_v9.10_8TeV/MC/ZZJetsTo2L2Q', 1, 'ZZJetsTo2L2Q ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('ZZJetsTo4L', t3storage2+'/nuTuples_v9.10_8TeV/MC/ZZJetsTo4L', 2, 'ZZJetsTo4L ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('T_s', t3storage2+'/nuTuples_v9.10_8TeV/MC/T_s', 1, 'T_s ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('T_t', t3storage2+'/nuTuples_v9.10_8TeV/MC/T_t', 1, 'T_t ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('T_tW', t3storage2+'/nuTuples_v9.10_8TeV/MC/T_tW', 1, 'T_tW ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
    configs.append(b.JobConfig('Tbar_s', t3storage2+'/nuTuples_v9.10_8TeV/MC/Tbar_s', 1, 'Tbar_s ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
