...
#################
  ...
  configs.append(b.JobConfig('TT_FCNH_M30', t3storage+'/nuTuples_v9.10_8TeV/MC/TT_FCNH_M30', 5, 'TT_FCNH_M30 ABCD {0} 2012 {1} {2}'.format(leptonDict[lepton],pu,analyzer),leptonDict[lepton]))
