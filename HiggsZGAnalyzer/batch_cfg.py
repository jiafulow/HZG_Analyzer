...
if os.environ.get('AT_NWU') == None:
  ...
  if doMuMuGamma:
    ...
    configs.append(b.JobConfig('whHZG_M120', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M120_RD1', 5, 'Signal2012whM120 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M125', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M125_RD1', 5, 'Signal2012whM125 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M130', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M130_RD1', 5, 'Signal2012whM130 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M135', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M135_RD1', 5, 'Signal2012whM135 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M140', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M140_RD1', 5, 'Signal2012whM140 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M145', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M145_RD1', 5, 'Signal2012whM145 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M150', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M150_RD1', 5, 'Signal2012whM150 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M155', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M155_RD1', 5, 'Signal2012whM155 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('whHZG_M160', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M160_RD1', 5, 'Signal2012whM160 ABCD mumuGamma 2012','mumuGamma'))

    configs.append(b.JobConfig('zhHZG_M120', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M120_RD1', 5, 'Signal2012zhM120 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M125', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M125_RD1', 5, 'Signal2012zhM125 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M130', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M130_RD1', 5, 'Signal2012zhM130 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M135', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M135_RD1', 5, 'Signal2012zhM135 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M140', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M140_RD1', 5, 'Signal2012zhM140 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M145', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M145_RD1', 5, 'Signal2012zhM145 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M150', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M150_RD1', 5, 'Signal2012zhM150 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M155', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M155_RD1', 5, 'Signal2012zhM155 ABCD mumuGamma 2012','mumuGamma'))
    configs.append(b.JobConfig('zhHZG_M160', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M160_RD1', 5, 'Signal2012zhM160 ABCD mumuGamma 2012','mumuGamma'))
  ...
  if doEEGamma:
    ...
    configs.append(b.JobConfig('whHZG_M120', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M120_RD1', 5, 'Signal2012whM120 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M125', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M125_RD1', 5, 'Signal2012whM125 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M130', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M130_RD1', 5, 'Signal2012whM130 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M135', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M135_RD1', 5, 'Signal2012whM135 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M140', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M140_RD1', 5, 'Signal2012whM140 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M145', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M145_RD1', 5, 'Signal2012whM145 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M150', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M150_RD1', 5, 'Signal2012whM150 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M155', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M155_RD1', 5, 'Signal2012whM155 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('whHZG_M160', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M160_RD1', 5, 'Signal2012whM160 ABCD eeGamma 2012','eeGamma'))

    configs.append(b.JobConfig('zhHZG_M120', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M120_RD1', 5, 'Signal2012zhM120 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M125', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M125_RD1', 5, 'Signal2012zhM125 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M130', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M130_RD1', 5, 'Signal2012zhM130 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M135', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M135_RD1', 5, 'Signal2012zhM135 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M140', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M140_RD1', 5, 'Signal2012zhM140 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M145', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M145_RD1', 5, 'Signal2012zhM145 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M150', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M150_RD1', 5, 'Signal2012zhM150 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M155', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M155_RD1', 5, 'Signal2012zhM155 ABCD eeGamma 2012','eeGamma'))
    configs.append(b.JobConfig('zhHZG_M160', t3storage+'/nuTuples_v9.6_8TeV/MC/whzhHZG_M160_RD1', 5, 'Signal2012zhM160 ABCD eeGamma 2012','eeGamma'))
